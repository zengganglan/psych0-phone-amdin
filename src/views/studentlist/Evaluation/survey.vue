  ...
  <div class="main">
    ...
    <div class="data">
      ...
      width="55">
        ...
        <el-table-column property="b" label="量表名称" ></el-table-column>
        <el-table-column property="c" label="简介" ></el-table-column>
        <el-table-column property="d" label="指导语" ></el-table-column>
        <el-table-column property="d" label="完成" ></el-table-column>
