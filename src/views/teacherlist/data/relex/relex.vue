<template>
  <div class="main">
    ...
    <div class="pages">
          ...
          ></el-pagination>
           ...
           <el-dialog title="团体辅导添加" :visible.sync="dialogFormVisible">
  <el-form :model="form">
    <el-form-item label="团体辅导组名称" :label-width="formLabelWidth" >
  ...
  <el-dialog title="团体辅导编辑" :visible.sync="dialogFormVisible1">
  <el-form :model="form1">
    <el-form-item label="团体辅导名称" :label-width="formLabelWidth" >
...
export default {
  ...
  methods: {
    ...
    handleCurrentChange(val) {
      ...
      this.$router.push({path:"/data/relexdetail",query:{id:id,name:name}})
