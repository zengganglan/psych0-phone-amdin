  ...
  <div class="main">
        ...
        <li>    
           <el-input placeholder="请输入内容" v-model="formLabelWidth" class="input-with-select">
              <el-select v-model="select" slot="prepend" placeholder="请选择">
                <el-option label="认识自我" value="1"></el-option>
                <el-option label="心理健康" value="2"></el-option>
                <el-option label="自由量表" value="3"></el-option>
                <el-option label="人际关系" value="3"></el-option>
              </el-select>
    ...
    <div class="data">
     <el-tabs type="card" v-model="activeName" @tab-click="handleClick">
      ...
      <el-dialog title="量表二维码" :visible.sync="dialogFormVisible" @opened="useqrcode" width="200px">
        <!-- <div class="tilt"><img src="../../../../assets/images/erweima.png" alt=""></div> -->
        <canvas id="canvas" ref="canvas" style="margin-left:10px"></canvas>
      </el-dialog>
      <el-dialog
        title="症状自评量表(SCL-90)"
