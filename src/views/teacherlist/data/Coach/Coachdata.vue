<template>
  <div class="main">
    ...
    <div class="pages">
          ...
          ></el-pagination>
           ...
           <el-dialog title="身心反馈添加" :visible.sync="dialogFormVisible">
  <el-form :model="form">
    <el-form-item label="身心反馈名称" :label-width="formLabelWidth" >
  ...
  <el-dialog title="身心反馈编辑" :visible.sync="dialogFormVisible1">
  <el-form :model="form1">
    <el-form-item label="身心反馈名称" :label-width="formLabelWidth" >
...
export default {
  ...
  methods: {
    ...
    handleCurrentChange(val) {
      ...
      this.$router.push({path:"/data/Coachdetail",query:{id:id,name:name}})
