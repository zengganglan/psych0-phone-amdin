<template>
  <div class="main">
    ...
    <div class="pages">
          ...
          ></el-pagination>
           ...
           <el-dialog title="放松组添加" :visible.sync="dialogFormVisible">
  <el-form :model="form">
    <el-form-item label="放松组名称" :label-width="formLabelWidth" >
  ...
  <el-dialog title="放松组编辑" :visible.sync="dialogFormVisible1">
  <el-form :model="form1">
    <el-form-item label="放松组名称" :label-width="formLabelWidth" >
