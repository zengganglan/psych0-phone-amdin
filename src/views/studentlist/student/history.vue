  ...
  <div class="main">
    ...
    <div class="data">
      ...
      width="55">
        ...
        <el-table-column property="c" label="填写时间" ></el-table-column>
        <el-table-column property="d" label="咨询时间" ></el-table-column>
        <el-table-column property="d" label="咨询方式" ></el-table-column>
        <el-table-column property="d" label="咨询状态" ></el-table-column>

         <el-table-column label="操作">
      <template slot-scope="scope">
        <el-button
          size="mini"
          @click.stop="handleEdit(scope.$index, scope.row)">详细</el-button>
        <el-button
          size="mini"
          type="danger"
          @click.stop="handleDelete(scope.$index, scope.row)">取消</el-button>
      </template>
    </el-table-column>
      </el-table>
    </div>
...
export default {
  data() {
    return {
      ...
      // 头部组件信息
      headson: ["咨询记录","可以预约咨询，查看预约记录，咨询记录"],
      tableData: [],
      tableData3:[
        {
          a: '1',
