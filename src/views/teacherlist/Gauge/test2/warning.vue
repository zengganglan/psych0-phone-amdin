  ...
  <div class="main">
    ...
    <div class="data">
      ...
      >
        ...
        <el-table-column prop="2" label="学号"></el-table-column>
        <el-table-column prop="3" label="姓名"></el-table-column>

        <el-table-column prop="4" label="性别"></el-table-column>
        <el-table-column prop="5" label="量表"></el-table-column>
        <el-table-column prop="6" label="耗时"></el-table-column>
        <el-table-column prop="7" label="测评时间"></el-table-column>
        <el-table-column prop="8" label="类型"></el-table-column>
        <el-table-column prop="9" label="有效"></el-table-column>
